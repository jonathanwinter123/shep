...
const tokyoNight: ShepTheme = {
  ...
  bgRadial1: "rgba(120, 187, 255, 0.24)",
  bgRadial2: "rgba(120, 255, 214, 0.14)",
  bgRadial3: "rgba(255, 158, 119, 0.14)",
  bgLinearFrom: "#07101b",
  bgLinearMid: "#0c1523",
  bgLinearTo: "#09111d",

  ambientOrb1: "rgba(62, 142, 255, 0.24)",
  ambientOrb2: "rgba(77, 245, 203, 0.16)",
  ambientOrb3: "rgba(255, 145, 103, 0.14)",

  frameTint: "rgba(6, 11, 19, 0.3)",
  panelTint: "rgba(10, 17, 29, 0.52)",
...
const dracula: ShepTheme = {
  ...
  bgRadial1: "rgba(189, 147, 249, 0.22)",
  bgRadial2: "rgba(80, 250, 123, 0.14)",
  bgRadial3: "rgba(255, 121, 198, 0.14)",
  bgLinearFrom: "#1a1028",
  bgLinearMid: "#1e1332",
  bgLinearTo: "#171023",

  ambientOrb1: "rgba(139, 100, 220, 0.24)",
  ambientOrb2: "rgba(80, 250, 123, 0.16)",
  ambientOrb3: "rgba(255, 85, 85, 0.14)",

  frameTint: "rgba(15, 10, 25, 0.3)",
  panelTint: "rgba(22, 15, 38, 0.52)",
  glassBorder: "rgba(255, 255, 255, 0.12)",
