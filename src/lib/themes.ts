...
const cheviot: ShepTheme = {
  ...
  bgRadial1: "rgba(140, 170, 220, 0.14)",
  bgRadial2: "rgba(140, 200, 160, 0.10)",
  bgRadial3: "rgba(200, 140, 170, 0.10)",
  bgLinearFrom: "#363c4a",
  bgLinearMid: "#3d4452",
  bgLinearTo: "#363c4a",

  ambientOrb1: "rgba(140, 170, 220, 0.16)",
  ambientOrb2: "rgba(140, 200, 160, 0.12)",
  ambientOrb3: "rgba(200, 140, 170, 0.12)",
