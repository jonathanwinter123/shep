...
export default function TabBar({
  ...
  // Only subscribe to global overlay state (Settings, Usage, Ports, Sessions, Files)
  const { settingsActive, usagePanelActive, portsPanelActive, sessionHistoryActive, filePreviewActive } = useUIStore(useShallow((s) => ({
  ...
  const anyOverlay = settingsActive || usagePanelActive || portsPanelActive || sessionHistoryActive || filePreviewActive;
